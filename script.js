if (!localStorage.getItem('moto_produtos')) {
    const produtosIniciais = [
        ...
        { id: 3, nome: "Kit Biela com Rolamento", precoCompra: 80.00, preco: 135.00, imagem: "https://images.unsplash.com/photo-1590518776829-4fbceebed1b8?auto=format&fit=crop&q=80&w=400", estoque: 0 },
...
function renderizarProdutos(lista = produtos) {
    ...
    lista.forEach(produto => {
        ...
        const estiloBotao = temEstoque ? "" : "background-color: #444; color: #888; cursor: not-allowed;";
